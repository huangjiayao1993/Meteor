...
insert  into `sys_config`(`id`,`key`,`value`,`desc`) values ('1687284031457284098','open_captcha','true','是否开启验证码'),('1687284031457284099','oss_type','HUAWEI','OSS云存储使用类型-动态配置项，可选值为：HUAWEI、ALI、TENCENT、QINIU、MINIO，如值不在列表或无此动态配置，系统默认HUAWEI');
